...
# USER SETTINGS
# =========================
EQUILIBRIUM_CSV="$ROOT_DIR/stationary_detection/newton_equilibrium.csv"
...
# Eigenfunctions are normalized before subtraction, so this is their coefficient.
MODE_AMPLITUDE="1e-3"
# =========================

if [[ ! -f "$EQUILIBRIUM_CSV" ]]; then
  echo "[stability] Equilibrium CSV not found: $EQUILIBRIUM_CSV" >&2
  echo "[stability] Run: bash $ROOT_DIR/scripts/newton_from_csv.sh" >&2
  exit 1
fi
...
echo "[stability] equilibrium: $EQUILIBRIUM_CSV"
